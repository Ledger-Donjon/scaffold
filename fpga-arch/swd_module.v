...
//
// On Thu Sep  5 16:29:16 CEST 2024
//
//
// Ports:
// Name                         I/O  size props
...
module swd_module(CLK,
  ...
  // value method trigger
  assign trigger = WILL_FIRE_RL_do_idle && cmd[6] ;
  ...
  assign MUX_swd_controller_cnt$write_1__VAL_6 =
	     (swd_controller_prescaler_ctr$Q_OUT == 8'd0) ? x__h14825 : 7'd1 ;
  ...
  assign MUX_swd_controller_packet$write_1__VAL_2 =
	     { 1'd1, cmd[3:0], cmd[2] ? x__h20049 : x__h21248, 2'd1 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_swd_controller_cnt$write_1__SEL_1:
	  swd_controller_cnt$D_IN = x__h14825;
      MUX_swd_controller_cnt$write_1__SEL_2:
  ...
  assign i__h1365 = 7'd71 - swd_controller_cnt ;
  assign swd_controller_cnt_2_ULE_8___d35 = swd_controller_cnt <= 7'd8 ;
  assign swd_controller_data_2_BIT_0_5_XOR_swd_controll_ETC___d301 =
	     z__h35353 ^ swd_controller_data[32] ;
  assign x__h1346 = _0xE79E__q2[i__h1365[3:0]] ;
  assign x__h14825 = swd_controller_cnt - 7'd1 ;
  assign x__h20049 = x__h20062 ^ cmd_BITS_1_TO_0__q1[1] ;
  assign x__h20062 = x__h20064 ^ cmd_BITS_1_TO_0__q1[0] ;
  assign x__h20064 = ~cmd[3] ;
  assign x__h21248 = x__h21261 ^ cmd_BITS_1_TO_0__q1[1] ;
  assign x__h21261 = cmd[3] ^ cmd_BITS_1_TO_0__q1[0] ;
  assign z__h24495 = wdata[24] ^ wdata[25] ;
  assign z__h24502 = z__h24495 ^ wdata[26] ;
  assign z__h24509 = z__h24502 ^ wdata[27] ;
  assign z__h24516 = z__h24509 ^ wdata[28] ;
  assign z__h24523 = z__h24516 ^ wdata[29] ;
  assign z__h24530 = z__h24523 ^ wdata[30] ;
  assign z__h24537 = z__h24530 ^ wdata[31] ;
  assign z__h24544 = z__h24537 ^ wdata[16] ;
  assign z__h24551 = z__h24544 ^ wdata[17] ;
  assign z__h24558 = z__h24551 ^ wdata[18] ;
  assign z__h24565 = z__h24558 ^ wdata[19] ;
  assign z__h24572 = z__h24565 ^ wdata[20] ;
  assign z__h24579 = z__h24572 ^ wdata[21] ;
  assign z__h24586 = z__h24579 ^ wdata[22] ;
  assign z__h24593 = z__h24586 ^ wdata[23] ;
  assign z__h24600 = z__h24593 ^ wdata[8] ;
  assign z__h24607 = z__h24600 ^ wdata[9] ;
  assign z__h24614 = z__h24607 ^ wdata[10] ;
  assign z__h24621 = z__h24614 ^ wdata[11] ;
  assign z__h24628 = z__h24621 ^ wdata[12] ;
  assign z__h24635 = z__h24628 ^ wdata[13] ;
  assign z__h24642 = z__h24635 ^ wdata[14] ;
  assign z__h24649 = z__h24642 ^ wdata[15] ;
  assign z__h24656 = z__h24649 ^ wdata[0] ;
  assign z__h24663 = z__h24656 ^ wdata[1] ;
  assign z__h24670 = z__h24663 ^ wdata[2] ;
  assign z__h24677 = z__h24670 ^ wdata[3] ;
  assign z__h24684 = z__h24677 ^ wdata[4] ;
  assign z__h24691 = z__h24684 ^ wdata[5] ;
  assign z__h24698 = z__h24691 ^ wdata[6] ;
  assign z__h35143 = swd_controller_data[0] ^ swd_controller_data[1] ;
  assign z__h35150 = z__h35143 ^ swd_controller_data[2] ;
  assign z__h35157 = z__h35150 ^ swd_controller_data[3] ;
  assign z__h35164 = z__h35157 ^ swd_controller_data[4] ;
  assign z__h35171 = z__h35164 ^ swd_controller_data[5] ;
  assign z__h35178 = z__h35171 ^ swd_controller_data[6] ;
  assign z__h35185 = z__h35178 ^ swd_controller_data[7] ;
  assign z__h35192 = z__h35185 ^ swd_controller_data[8] ;
  assign z__h35199 = z__h35192 ^ swd_controller_data[9] ;
  assign z__h35206 = z__h35199 ^ swd_controller_data[10] ;
  assign z__h35213 = z__h35206 ^ swd_controller_data[11] ;
  assign z__h35220 = z__h35213 ^ swd_controller_data[12] ;
  assign z__h35227 = z__h35220 ^ swd_controller_data[13] ;
  assign z__h35234 = z__h35227 ^ swd_controller_data[14] ;
  assign z__h35241 = z__h35234 ^ swd_controller_data[15] ;
  assign z__h35248 = z__h35241 ^ swd_controller_data[16] ;
  assign z__h35255 = z__h35248 ^ swd_controller_data[17] ;
  assign z__h35262 = z__h35255 ^ swd_controller_data[18] ;
  assign z__h35269 = z__h35262 ^ swd_controller_data[19] ;
  assign z__h35276 = z__h35269 ^ swd_controller_data[20] ;
  assign z__h35283 = z__h35276 ^ swd_controller_data[21] ;
  assign z__h35290 = z__h35283 ^ swd_controller_data[22] ;
  assign z__h35297 = z__h35290 ^ swd_controller_data[23] ;
  assign z__h35304 = z__h35297 ^ swd_controller_data[24] ;
  assign z__h35311 = z__h35304 ^ swd_controller_data[25] ;
  assign z__h35318 = z__h35311 ^ swd_controller_data[26] ;
  assign z__h35325 = z__h35318 ^ swd_controller_data[27] ;
  assign z__h35332 = z__h35325 ^ swd_controller_data[28] ;
  assign z__h35339 = z__h35332 ^ swd_controller_data[29] ;
  assign z__h35346 = z__h35339 ^ swd_controller_data[30] ;
  assign z__h35353 = z__h35346 ^ swd_controller_data[31] ;
